...
#' @description
#' NEON observational data may contain duplicates; this function removes exact duplicates and attempts to resolve non-exact duplicates, and flags duplicates that can't be resolved.
#'
#' @param data A data frame containing data from a NEON data table
#' @param variables The variables file containing the data table
#' @param table The name of the table. Must match one of the table names in 'variables'
